...
var debugOrder = function (orders) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        tools_1.saveToFile("clearedData", orders);
        return [2];
    });
}); };
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, tools_1.readFile("newData")];
            case 1:
                orders = _a.sent();
                console.log("debug orders", orders.length);
                exports.debugOrder(orders);
                return [2];
        }
    });
}); })();
